...
class Pantalla2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Calcular el total del precio para los productos en Pantalla2
    final totalPrecio = inventarioProvider.productosPantalla2.fold<double>(
      0,
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              itemCount: inventarioProvider.productosPantalla2.length,
              itemBuilder: (context, index) {
                final producto = inventarioProvider.productosPantalla2[index];
                return ListTile(
                            ...
                            builder: (context) {
                              return AlertDialog(
                                ...
                                actions: [
                                  ...
                                  TextButton(
                                    onPressed: () {
                                      inventarioProvider.eliminarProductoPantalla2(index);
                                      Navigator.of(context).pop();
                                    },
                                    child: Text('Eliminar'),
                                  ),
